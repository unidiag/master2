...
if (
    ...
    if ($module === 'zayavki') {
        if ($postAction === 'create') {
            ...
            /*
            * Если при завершении заявки мастер оставил
            * установленным "Вернуть подключение",
            * снимаем активное отключение абонента.
            */
            if (
                isset($_POST['reconnect'])
                && (string) $_POST['reconnect'] === '1'
            ) {
                $disconnectAddress = trim(
                    (string) (
                        $ticket['address']
                        ?? ''
                    )
                ...
                /*
                * В старых заявках адрес мог находиться
                * в address_ajax.
                */
