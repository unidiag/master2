            ...
            <?php foreach ($payments as $payment): ?>
                ...
                >
                    ...
                    <div class="payment-item__description">
                        ...
                        <?php elseif ($isDisconnectCreated): ?>
                    ...
                    <div class="payment-item__amount">
                        ...
                        <?php if ($isServiceEvent): ?>
                            ...
                            <?php if ($serviceResult !== ''): ?>
                                ...
                                <span
                                    class="payment-item__balance"
                                    title="<?= e($serviceResult) ?>"
                                >
                                    Выполнено
                                </span>
...
<?php elseif ($house !== ''): ?>
    ...
    <?php else: ?>
                    ...
                    <?php if ($debt != 0): ?>
                        <div class="<?= $debt > 0
                            ? 'apartment-card__debt'
                                . (
                                    $debt >= $nearbyDebtorMinDebt
                                        ? ' apartment-card__debt--warning'
                                        : ''
                                )
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            * по выбранному количеству квартир.
            */
            renderApartmentGroups();

            /*
            * Если в URL указан номер квартиры:
            *
            * #123
            *
            * прокручиваем страницу до неё после
            * формирования групп квартир.
            */
